      ...
      >
        <div class="flex flex-col py-1" role="menu" aria-orientation="vertical">
          ...
          <button
            type="button"
            phx-click="filter_by_type"
            phx-value-type="student_mentions"
            class="w-full px-4 py-2 text-center text-sm text-[#1C1C1E] hover:bg-[#1C1C1E] hover:text-[#FFFFFF] transition-colors"
            role="menuitem"
          >
            Student Mentions
          ...
          <button
            type="button"
            phx-click="filter_by_type"
            phx-value-type="mentor_mentions"
            class="w-full px-4 py-2 text-center text-sm text-[#1C1C1E] hover:bg-[#1C1C1E] hover:text-[#FFFFFF] transition-colors"
            role="menuitem"
          >
            Mentor Mentions
          ...
          <button
            type="button"
            phx-click="filter_by_type"
            phx-value-type="cohort_mentions"
            class="w-full px-4 py-2 text-center text-sm text-[#1C1C1E] hover:bg-[#1C1C1E] hover:text-[#FFFFFF] transition-colors"
            role="menuitem"
          >
            Cohort Mentions
