defmodule EvalioAppWeb.NoteTagMenu do
  ...
  def render(assigns) do
    ...
    <div class="relative">
      <button
        type="button"
        class="w-[60px] h-[30px] bg-[#D9D9D9] text-white text-sm flex items-center justify-center rounded-full cursor-pointer hover:bg-[#D9D9D9] transition-all outline-none"
      ...
      >
        <div class="flex flex-col" role="menu" aria-orientation="vertical">
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#FF655F] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#FF9F0B] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#FFD60D] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#32D74B] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#02B1FF] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#9849E8] transition-all text-gray-700" role="menuitem">
          ...
          <button type="button" class="group w-full px-4 py-2 flex items-center space-x-3 hover:bg-[#D9D9D9] transition-all text-gray-700" role="menuitem">
