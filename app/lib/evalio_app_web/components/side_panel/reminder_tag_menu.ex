defmodule EvalioAppWeb.ReminderTagMenu do
  ...
  def render(assigns) do
    ...
    <div class="h-full relative">
      <button
        type="button"
        class={"w-[40px] h-full #{tag_color_class(@reminder.tag)} text-white text-xs flex items-center justify-center rounded-l-lg cursor-pointer hover:#{tag_color_class(@reminder.tag)} transition-all outline-none"}
