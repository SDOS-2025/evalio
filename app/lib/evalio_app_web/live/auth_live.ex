defmodule EvalioAppWeb.AuthLive do
  ...
  def handle_event("signup", %{"user" => user_params}, socket) do
    ...
    {:noreply,
     ...
     |> assign(
       :error_message,
       "Sign up is currently disabled. Please use the provided credentials."
     )
     |> assign(:form, to_form(%{}, as: "user"))}
  end
    ...
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <.form
            for={@form}
            phx-submit={if @page == "login", do: "login", else: "signup"}
            class="space-y-6"
          >
            <div>
          ...
          <div class="mt-6">
            ...
            <div class="mt-6">
              <button
                phx-click="switch-page"
                phx-value-page={if @page == "login", do: "signup", else: "login"}
